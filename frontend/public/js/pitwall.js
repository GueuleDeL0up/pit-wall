...
function renderLap() {
  ...
  document.getElementById('lapTotalDisplay').textContent = TOTAL;
...
// ---- Nombre de tours du circuit (modifiable) ----
document.getElementById('lapTotalInput').addEventListener('change', e => {
